...
% Sabon from Typekit
\setmainfont[
  Path={\string~/Library/Application Support/Adobe/CoreSync/plugins/livetype/.r/},
  BoldFont={.39438.otf},
  ItalicFont={.39440.otf},
  BoldItalicFont={.39439.otf},

  Ligatures={NoCommon} % Disable ligatures
]{.39441.otf}

% Gill Sans Nova, also from Typekit
\setsansfont[
  Path={\string~/Library/Application Support/Adobe/CoreSync/plugins/livetype/.r/},
  BoldFont={.39304.otf},
  ItalicFont={.39298.otf},
  BoldItalicFont={.39305.otf},

  Numbers={Proportional} % Use proportional text figures
]{.39297.otf}
